    ...
    <div className=" bg-black/80 bg-[url('https://i.ibb.co/VYM4s3t/matteo-vistocco-Dph00-R2-Sw-Fo-unsplash.jpg')] bg-cover bg-center bg-blend-darken text-white flex flex-col justify-center items-center py-36 tracking-normal text-justify">
      <div>
        ...
        <div className=" py-10 px-6 max-w-6xl">
          {/* intro */}
          <div className="">
            <p data-aos="flip-up" className="font-bold mb-4">
              We are a team of passionate professionals dedicated to delivering
              exceptional solutions tailored to meet your unique needs. With
              years of experience in the industry, we combine creativity,
              technical expertise, and a customer-centric approach to exceed
              your expectations.
            </p>
            <p data-aos="flip-down" className="mb-4 font-bold">
              Our mission is to empower businesses and individuals with
              innovative solutions that drive growth and success. We believe in
              building strong partnerships and providing the highest level of
              service and support.
            </p>
          </div>
          ...
          <div className="py-10">
            ...
            <ul
              data-aos="fade-up"
              className="list-disc pl-4 mb-4 font-bold list-inside"
            >
          ...
          <div className="py-10">
            ...
            <p data-aos="fade-up" className="mb-4 font-bold">
              Meet the talented individuals behind our success. Our team brings
              a diverse range of skills and experiences to the table, ensuring
              that we can tackle any challenge with creativity and expertise.
            </p>
            <div className="grid grid-cols-1 my-16 lg:grid-cols-2 justify-center items-center gap-y-24 gap-x-16 font-bold">
              {teamMembers.map((member, index) => (
                <div
                  data-aos="flip-left"
                  key={index}
                  className="bg-white/80 p-6 rounded shadow-2xl"
                >
                  <img
                    src={member.imageUrl}
                    alt={member.name}
                  ...
                  <div className="py-4">
                    ...
                    <p className="text-black/40">{member.bio}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div data-aos="fade-up" className="text-center font-bold pt-10">
            <p>
              ...
              achieve your goals. Feel free to reach out to us with any
