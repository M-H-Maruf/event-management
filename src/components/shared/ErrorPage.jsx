...
const ErrorPage = () => {
  ...
  return (
    <div data-aos="fade-down" className=" bg-black/80 w-screen h-screen bg-[url('https://i.ibb.co/VYM4s3t/matteo-vistocco-Dph00-R2-Sw-Fo-unsplash.jpg')] bg-cover bg-center bg-blend-darken text-white flex flex-col justify-center items-center pb-36 pt-28 tracking-normal text-justify">
